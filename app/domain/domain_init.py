...
def init_from_db(db: Session):
    ...
    * 조립은 계층이 아니라 진입점 책임이라 이 파일만 domain 에서 repositories 를 안다.
    ...
    product_mgr.set_ingredient_allergen(get_ingredient_allergen_ids(db))
