...
if __name__ == '__main__':
    ...
    print(f"상품 {len(rows)}건 조립")
    assert len(rows) == len(get_products())
    print("#"*20)

    for row in rows[:3]:
        print(product_text(row))
        print("-"*20)
    print("#"*20)
