...
from app.repositories.general_query import select, select_all, select_range, update_query, update_query_all
...
if __name__ == "__main__":
    ...
    try:
        ...
        assert set(select("product", {"product_id": product_id}, cols=["name", "price_krw"])[0]) == {
            "name",
            "price_krw",
        }
        ...
        assert select("product", {"product_id": [product_id]}) == select(
