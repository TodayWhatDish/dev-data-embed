...
if __name__ == "__main__":
    ...
    assert ok == {"json_ok": True, "n_picks": 5, "out_of_range": 0, "duplicated": False, "schema_ok": True}, (
        ok
    )
    ...
    assert clean == {"n_mentioned": 1, "n_from_candidates": 1, "n_invented": 0, "invented": []}, clean
